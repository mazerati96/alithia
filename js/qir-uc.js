// ============================================================
//  js/qir-uc.js  —  Alithia Country / Continent Page
//
...
//  ────────────────────────────────────────────────────────────
const PAGE_ID = "qir uc";    // ← change this per page
const PAGE_SLUG = "qir uc";    // ← change this per page (usually same)
...
async function writeChangelog(type, sectionTitle, preview = "") {
    const pageLabel = PAGE_ID.charAt(0).toUpperCase() + PAGE_ID.slice(1); // "qir uc → "Qir Uc"
