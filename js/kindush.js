// ============================================================
//  js/kindush.js  —  Alithia Country / Continent Page
//
...
//  ────────────────────────────────────────────────────────────
const PAGE_ID = "kindush";    // ← change this per page
const PAGE_SLUG = "kindush";    // ← change this per page (usually same)
...
async function writeChangelog(type, sectionTitle, preview = "") {
    const pageLabel = PAGE_ID.charAt(0).toUpperCase() + PAGE_ID.slice(1); // "kindush" → "Kindush"
