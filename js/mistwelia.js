// ============================================================
//  js/mistwelia.js  —  Alithia Country / Continent Page
//
...
//  ────────────────────────────────────────────────────────────
const PAGE_ID = "mistwelia";    // ← change this per page
const PAGE_SLUG = "mistwelia";    // ← change this per page (usually same)
...
async function writeChangelog(type, sectionTitle, preview = "") {
    const pageLabel = PAGE_ID.charAt(0).toUpperCase() + PAGE_ID.slice(1); // "mistwelia" → "Mistwelia"
