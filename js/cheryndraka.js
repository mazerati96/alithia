// ============================================================
//  js/cheryndraka.js  —  Alithia Country / Continent Page
//
...
//  ────────────────────────────────────────────────────────────
const PAGE_ID = "cheryndraka";    // ← change this per page
const PAGE_SLUG = "cheryndraka";    // ← change this per page (usually same)
...
async function writeChangelog(type, sectionTitle, preview = "") {
    const pageLabel = PAGE_ID.charAt(0).toUpperCase() + PAGE_ID.slice(1); // "cheryndraka" → "Cheryndraka"
