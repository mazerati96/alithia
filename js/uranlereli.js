// ============================================================
//  js/uranlereli.js  —  Alithia Country / Continent Page
//
...
//  ────────────────────────────────────────────────────────────
const PAGE_ID = "uranlereli";    // ← change this per page
const PAGE_SLUG = "uranlereli";    // ← change this per page (usually same)
...
async function writeChangelog(type, sectionTitle, preview = "") {
    const pageLabel = PAGE_ID.charAt(0).toUpperCase() + PAGE_ID.slice(1); // "uranlereli" → "Uranlereli"
